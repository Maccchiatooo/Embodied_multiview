...
EXAMPLE = [
    {
        "image": "mypic/multiview/1.png",
        "text": "put the red scissors onto stool",
        "mode": "VTG"
    },
    {
        "image": "mypic/multiview/2.png",
        "text": "put the red scissors onto stool",
        "mode": "VTG"
    },
    {   
        "image": "mypic/multiview/3.png",
        "text": "put the red scissors onto stool",
        "mode": "VTG"
    },
    {
        "image": "mypic/multiview/4.png",
        "text": "put the red scissors onto stool",
        "mode": "VTG"
    },
    {   
        "image": "mypic/multiview/5.png",
        "text": "put the red scissors onto stool",
        "mode": "VTG"
    },
]
...
def _load_model_processor(checkpoint_path=DEFAULT_CKPT_PATH, cpu_only=False, flash_attn2=False):
    ...
    processor = AutoProcessor.from_pretrained(checkpoint_path,max_pixels=1280*28*28,)
...
def process_single_example(model, processor, example, base_image_dir="", output_dir="output"):
    ...
    try:
        ...
        if coordinates:
            ...
            visual_image_path = os.path.join(output_dir, f"{image_name}_{mode}_visualized.png")
